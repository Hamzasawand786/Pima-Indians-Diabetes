...
if st.session_state.theme == "light":
    ...
    .main-title {font-size:42px;font-weight:800;color:#0b3c5d;}
    ...
    .main-title {font-size:42px;font-weight:800;color:#00c6ff;}
...
MODEL_ACCURACY = 0.89   # update if needed
...
st.write("""
A premium healthcare dashboard that predicts whether a patient is **Diabetic** or **Non-Diabetic**
using Machine Learning and PCA. Designed for professional medical diagnostics and academic evaluation.
""")
